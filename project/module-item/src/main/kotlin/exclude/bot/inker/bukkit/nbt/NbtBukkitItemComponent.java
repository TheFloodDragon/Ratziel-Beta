...
import exclude.bot.inker.bukkit.nbt.internal.ref.RefBukkitItemStack;
import exclude.bot.inker.bukkit.nbt.internal.ref.RefCraftMetaItem;
...
public class NbtBukkitItemComponent implements NbtComponentLike {
  ...
  public Nbt<?> get(String key) {
    if (HANDLED_TAGS.contains(key)) {
      CallSiteInstaller.Spy.info("key " + key + "isn't support for direct access");
      return null;
    } else {
