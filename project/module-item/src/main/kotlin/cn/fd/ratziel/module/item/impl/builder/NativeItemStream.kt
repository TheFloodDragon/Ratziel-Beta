...
class NativeItemStream(
    ...
    override val tree: SynchronizedValue<JsonTree> = SynchronizedValue { JsonTree(origin.property) }

    override val data: SynchronizedValue<ItemData> = SynchronizedValue { item.data }
