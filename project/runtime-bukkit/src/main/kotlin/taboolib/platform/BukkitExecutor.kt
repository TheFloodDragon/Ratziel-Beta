...
import cn.fd.ratziel.library.folia.*
        ...
        if (started) {
            ...
            when {
                ...
                runnable.period > 0 -> if (runnable.async) {
                    ...
                    }.runTimerAsyncQuick(runnable.delay, runnable.period)
                } else {
                    object : BukkitRunnable() {
                        init {
                            task = BukkitPlatformTask(this)
                    ...
                    }.runTimerQuick(runnable.delay, runnable.period)
                }
                ...
                runnable.delay > 0 -> if (runnable.async) {
                    ...
                    }.runLaterAsyncQuick(runnable.delay)
                } else {
                    object : BukkitRunnable() {
                        init {
                            task = BukkitPlatformTask(this)
